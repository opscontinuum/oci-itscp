...
| Roles, authority, succession | `checklists/dr-authority-matrix.md` (authority table, "Standing decisions", "Contact roster", signature line); runbook headers ("Authority to invoke", "Approval") |
| Activation criteria and gate | `runbooks/RB-02-failover.md` §0; authority matrix standing decision 4 |
| Notification and contacts | `checklists/dr-authority-matrix.md` "Contact roster" (blank); `checklists/pre-failover-precheck.md` §E; `runbooks/RB-01-switchover.md` §1 (T-24 h) |
